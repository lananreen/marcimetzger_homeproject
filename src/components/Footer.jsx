...
const socialLinks = [
  { Icon: FacebookIcon, href: 'https://www.facebook.com/MarciHomes/', label: 'Facebook' },
  { Icon: InstagramIcon, href: 'https://www.instagram.com/marcimetzger_theridge/', label: 'Instagram' },
  { Icon: LinkedinIcon, href: 'https://www.linkedin.com/in/marci-metzger-30642496/', label: 'LinkedIn' },
  { Icon: YelpIcon, href: 'https://www.yelp.com/biz/marci-metzger-the-ridge-realty-pahrump', label: 'Yelp' },
]
...
function Footer() {
  return (
    <footer className="footer">
      ...
      <p className="footer-brand">MARCI METZGER - THE RIDGE REALTY GROUP</p>
      <p className="footer-copyright">Copyright © 2026 Marci METZGER - All Rights Reserved</p>
    </footer>
  )
}
